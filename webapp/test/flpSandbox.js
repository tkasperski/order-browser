		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Browser",
									"targetURL": "#OrderBrowser-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OrderBrowser-display": {
								"semanticObject": "OrderBrowser",
								"action": "display",
								"description": "A Fiori application for browsing orders",
								"title": "Order Browser",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=orderbrowser",
									"url": sap.ui.require.toUrl("orderbrowser")
								}
							}
						}
					}
